...
struct field main_list[] = {
  ...
  {FIELD_SELECTION, 376, 112, 80, 48, TFT_BLACK, "1T-FT8", "ON",  "ON/OFF"},
  
  {FIELD_SELECTION, 24,  176, 72,  48, TFT_BLACK, "WIFI",   "OFF", "ON/OFF"},
  {FIELD_SELECTION, 104, 176, 352, 48, TFT_BLACK, "IP",     "NOT CONNECTED", "NOT CONNECTED"},
  {-1}
};
#endif
